...
import image2 from "../assets/images/logofull.png";
  ...
  return (
    <>
      ...
      <motion.div
        ...
        bg-gradient-to-br from-via-blue-500 to-purple-600
      ...
      >
        ...
        <div className="px-4 py-6 shrink-0">
          <button
            ...
            className={`flex items-center rounded-xl py-3 px-4 bg-gradient-to-r from-pink-500 to-yellow-500 shadow-lg text-white font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl ${
              isOpen ? "justify-start" : "justify-center"
            }`}
          >
            <FontAwesomeIcon 
              icon={faSignOutAlt} 
              className={`transition-all duration-300 ${isOpen ? "mr-3" : ""}`} 
            />
